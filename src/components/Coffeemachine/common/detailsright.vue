<template>
	<div>
		...
		<div class="fl nps-xiangqing">
			...
			<div class="nps-mai-title1">Inissia C40 {{value}}</div>
			...
			<div class="text-l nps-sping-jiage">CNY {{price}}</div>
			<div class="text-l font-12 margin-t-5 cl-65">售价</div>
			<div class="text-l font-12 text-del cl-65">CNY {{discountPrice}}</div>
...
export default {
	...
	methods: {
		grthub () {
			...
			this.manual = this.$router.history.current.query.manual
			this.value = this.$router.history.current.query.value
