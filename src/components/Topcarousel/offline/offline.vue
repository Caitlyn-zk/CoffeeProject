...
<div>
    ...
    <div class="nps-main">
      <div class="nps-main-content content">
          ...
          <div class="nps-text">
              <p>作为一名尊贵的Nespresso会员，您可以注册并参与多种会员专享活动。从 精品店咖啡品鉴, 到 咖啡大师课，到与知名主厨一起参加美食工坊。如果您希望激发自己对咖啡更强烈的热爱，可以加入我们的咖啡爱好者社区，给自己带来满满惊喜！为了确保社区的氛围，会员数量有限，赶快注册吧！</p>
          </div>
          <div class="nps-find">
              <el-button>发现全部活动</el-button>
          </div>
          <div class="nps-city">
              <div class="nps-shanghai fl">
              </div>
              <div class="nps-shanghaicontent fl">
