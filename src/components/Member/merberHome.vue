      ...
      <div class="content bg-fruts">
        <div class="main-content text-center">
          ...
          <div class="link-description">
            <a>了解更多关于Nespresso可持续发展<i> ></i></a>
          <div class="fruits-img-box">
            <img src="./meberImg/lyk-icon-one.png"/>
            <img src="./meberImg/lyk-logob.png"/>
          </div>
          </div>
        </div>
      </div>
      ...
      <div class="content bg-machine-box">
        <div class="introduce">
          ...
          <ul class="introduce-machine">
            <li>
              <span>有好的操作</span>
              <p>现代风格的单杯Nespresso咖啡机，简单快速，易于操作。</p>
            </li>
            <li>
              <span>创新的设计</span>
              <p>哪款Nespresso咖啡机是适合您的一款？ 选择一款经典设计的咖啡机。</p>
            </li>
            <li>
              <span>两年保修期</span>
              <p>Nespresso咖啡机和Aeroccino奶沫机均提供两年保障。</p>
            </li>
          </ul>
        </div>
        <div class="bg-mathine"></div>
      </div>
      <!-- 咖啡机滑动轮播 -->
        ...
        <div class="mathine-slide-content">
          <div class="coffee-mate-box text-center">
            ...
            <ul class="mathine-introduce-text">
              <li>
                <p>如果您喜欢浓缩咖啡，Nespresso咖啡机采用高压萃取技术为您呈现每一粒咖啡胶囊的新鲜芳香。</p>
              </li>
              <li>
